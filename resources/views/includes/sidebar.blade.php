<aside id="layout-menu" class="layout-menu menu-vertical menu bg blue-theme" >
  <style>
/* BLUE THEME */
.blue-theme {
...
.blue-theme .menu-header-text,
.blue-theme .menu-link,
.blue-theme .menu-icon {
    color: #e0e7ff !important; /* biru muda lembut */
}

.blue-theme .menu-item.active > a {
    background: #3b82f6 !important; /* aksen biru terang */
    color: white !important;
    border-radius: 8px;
}

.blue-theme .menu-link:hover {
